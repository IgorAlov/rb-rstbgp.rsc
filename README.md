...
* Установить из репозитория github прямо на рутоер можно следующей командой: `/tool fetch url=https://raw.githubusercontent.com/IgorAlov/rb-rstbgp.rsc/main/rb-rstbgp.rsc mode=https ascii=yes keep-result=yes`, а после загрузки скрипта, необходимо произвести его импорт: ``/import rb-rstbgp.rsc``
